...
export const CreateTournamentSchema = z.object({
  ...
  registrationOpensAt: z.string().datetime().transform((v) => new Date(v)),
  registrationClosesAt: z.string().datetime().transform((v) => new Date(v)),
  drawDate: z.string().datetime().transform((v) => new Date(v)),
  ...
  prequalifierEndDate: z
    ...
    .optional()
    .transform((v) => (v ? new Date(v) : undefined)),
  mainStartDate: z.string().datetime().transform((v) => new Date(v)),
  mainEndDate: z
    .string()
    .datetime()
    .optional()
