...
export class KlubEntity {
  ...
  get maxSports(): number {
    return this.props.maxSports;
  }
  get maxCourts(): number {
    return this.props.maxCourts;
  }
  get isGroup(): boolean {
    return this.props.isGroup;
  }
  get parentKlubId(): string | null {
    return this.props.parentKlubId ?? null;
  }
